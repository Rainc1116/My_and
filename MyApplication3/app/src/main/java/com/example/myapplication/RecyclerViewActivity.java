...
import com.example.myapplication.LinearItemDecoration;
import com.example.myapplication.MyAdapter;
import com.example.myapplication.TestData;
import com.example.myapplication.TestDataSet;
...
//        animator.setAddDuration(3000);
    ...
    public void onItemCLick(int position, TestData data) {
        ...
        Intent intent = new Intent(this, RecycleInfo.class);
        intent.putExtra("xvhao",position + 1);
